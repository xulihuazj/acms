				...
				<div class="userbox">
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							...
							<li><a href="${base}/acms/modifyPassword.do"><i
									class="fa fa-unlock-alt"></i> 修改密码</a></li>
						...
						<nav id="menu" class="nav-main" role="navigation">
							<ul class="nav nav-sidebar">
								...
								<li class="nav-parent"><a> <i class="fa fa-tasks"
										aria-hidden="true"></i><span>人员信息管理</span>
								</a>
									<ul class="nav nav-children">
										<li><a href="#"><span class="text">全部学院</span></a>
											<ul class="">
												<li><a href="#"><span class="text">电气工程学院</span></a></li>
												<li><a href="#"><span class="text">粮油食品学院</span></a></li>
												<li><a href="#"><span class="text">生物工程学院</span></a></li>
												<li><a href="#"><span class="text">土木建筑学院</span></a></li>
												<li><a href="#"><span class="text">化学化工学院</span></a></li>
												<li><a href="#"><span class="text">材料科学与工程学院</span></a></li>
												<li><a href="#"><span class="text"> 管 理 学 院</span></a></li>
												<li><a href="#"><span class="text"> 理 学 院</span></a></li>
												<li><a href="#"><span class="text"> 法 学 院</span></a></li>
												<li><a href="#"><span class="text">设计艺术学院</span></a></li>
												<li><a href="#"><span class="text">中英国际学院</span></a></li>
												<li><a href="#"><span class="text"> 体育学院</span></a></li>
												<li><a href="#"><span class="text">艺术教育中心</span></a></li>
												<li><a href="#"><span class="text">机电工程学院</span></a></li>
												<li><a href="#"><span class="text">信息科学与工程学院</span></a></li>
												<li><a href="#"><span class="text">经济贸易学院</span></a></li>
												<li><a href="#"><span class="text"> 外 语 学 院</span></a></li>
												<li><a href="#"><span class="text">新闻与传播学院</span></a></li>
												<li><a href="#"><span class="text">国际教育学院</span></a></li>
												<li><a href="#"><span class="text">继续教育学院</span></a></li>
												<li><a href="#"><span class="text">马克思主义学院</span></a></li>
											</ul></li>
										<li><a href="#"><span class="text">全部专业</span></a>
											<ul>
								...
								<li class="nav-parent"><a> <i class="fa fa-list"
									...
									<ul class="nav nav-children">
										...
										<li><a href="deviceattach.htmlfs"><span class="text">设备连接设置</span></a></li>
									</ul></li>
								...
								<li class="nav-parent"><a> <i class="fa fa-retweet"
										aria-hidden="true"></i><span>数据分析管理</span>
								</a>
									<ul class="nav nav-children">
										<li><a href="#"><span class="text">数据验证</span></a></li>
										<li><a href="#"><span class="text">实时监控</span></a></li>
										<li><a href="#"><span class="text">统计分析</span></a></li>
									</ul></li>
								<li class="nav-parent"><a> <i class="fa fa-exchange"
									...
									<ul class="nav nav-children">
										...
										<li><a href="#"><span class="text" id="item">全部宿舍</span></a>
											<ul class="nav" style="display: none;">
												<li><a href="#"><span class="text">学生公寓A区</span></a></li>
												<li><a href="#"><span class="text">学生公寓B区</span></a></li>
												<li><a href="#"><span class="text">学生公寓C区</span></a></li>
												<li><a href="#"><span class="text">学生公寓D区</span></a></li>
												<li><a href="#"><span class="text">学生公寓E区</span></a></li>
												<li><a href="#"><span class="text">学生公寓F区</span></a></li>
											</ul></li>
										<!--
								...
								<li class="nav-parent"><a> <i class="fa fa-cog"
										aria-hidden="true"></i><span>系统用户管理</span>
								</a>
									<ul class="nav nav-children">
										<li><a href="#"><span class="text">系统参数设置</span></a></li>
										...
										<li><a href="${base}/acms/modifyPassword.do"><span
												class="text">修改密码</span></a></li>
									</ul></li>
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							<li><a href="index.html"><i class="icon fa fa-home"></i>我的管理中心</a></li>
						</ol>
					</div>
