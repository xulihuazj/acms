	...
	var datatableInit = function() {
		...
		var fnFormatDetails = function( datatable, tr ) {
			...
			return [
				...
				'<div>',
					'<tr>',
						'<td class=" label-info" " ><a id="eidtPerson"  style="color: white;">编辑人员</a></td>',
						'<td class=" label-success" ><a id="startPerson" style="color: white;">启用人员</a></td>',
						'<td class=" label-warning" ><a id="stopPerson"  style="color: white;">禁用人员</a></td>',
						'<td class=" label-danger" ><a id="deletePerson"  style="color: white;">删除人员</a></td>',
					'</tr>',
				'</div>',
				'</table>',
			].join('');
